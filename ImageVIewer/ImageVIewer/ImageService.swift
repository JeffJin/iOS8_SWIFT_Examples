...
//        let url = NSURL(string: "http://https://www.googleapis.com/customsearch/v1?key=AIzaSyBtY4ZzPSfMrKlf5Tyme4fSLLOcH9k8gYw&cx=017576662512468239146:omuauf_lfve&q=lectures")
...
//                    var temp = ImgResource(title: "No Title")
//                    temp.uiImage = UIImage(named: paths[0] as String)!
//                    imgs.append(temp)
                }
