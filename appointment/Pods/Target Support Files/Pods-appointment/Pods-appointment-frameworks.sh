...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-appointment/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework 'CKUITools.framework'
  install_framework 'ICLoader.framework'
  install_framework 'NGAParallaxMotion.framework'
  install_framework 'NSURL_QueryDictionary.framework'
  install_framework 'OCLogTemplate.framework'
  install_framework 'OMGHTTPURLRQ.framework'
  install_framework 'PaperFold.framework'
